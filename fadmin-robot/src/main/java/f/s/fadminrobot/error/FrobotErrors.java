...
public interface FrobotErrors {
   ...
   BaseError CategoryNotRelation();
   BaseError RobotNameLengthError();
   BaseError UnknownFile();
   BaseError FileTooLarge();
   BaseError ExtParamOutOfRange();
